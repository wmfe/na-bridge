...
window.BNJS.page = {
  back: log.bind(undefined, {
    back: 'nuomi call back'
  }),
  start: log.bind(undefined, {
    start: 'nuomi call start'
  }),
  onBtnBackClick: log.bind(undefined, {
